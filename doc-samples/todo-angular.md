...
---
# Todo-AngularJS Sample

The Todo-AngularJS sample demonstrates Breeze and <a href="http://angularjs.org/" target="_blank">AngularJS</a> working together in a single page CRUD (Create/Read/Update/Delete) application.

<p class="note">Check out John Lantz&#39;s <a href="http://www.codeproject.com/Articles/528262/Data-with-AngularJS-js" target="_blank">CodeProject article</a> describing this sample.</p>
