...
The Todo-AngularJS-Sequelize sample demonstrates Breeze, <a href="http://angularjs.org/" target="_blank">AngularJS</a> and <a href="http://docs.sequelizejs.com/" target="_blank">Sequelize</a> working together in a single page CRUD (Create/Read/Update/Delete) application.
