...
- **mergeOptions**:
  ...
  - **mergeStrategy**: A [`MergeStrategy`](http://www.breezejs.com/sites/all/apidocs/classes/MergeStrategy.html "API Docs: MergeStrategy") telling Breeze what to do when a queried entity is already in cache.
...
- ***saveBundle***:
  ...
  - **saveOptions**: an instance of [`SaveOptions`](http://www.breezejs.com/sites/all/apidocs/classes/SaveOptions.html "API Docs: SaveOptions"), either the one passed to the `EntityManager.saveChanges` or the ambient default instance.  
