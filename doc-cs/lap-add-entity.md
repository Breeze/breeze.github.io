...
<p>The <em>EntityType</em> is a container for metadata that describe a Breeze entity type. It knows about the type&rsquo;s constructor, validation rules, and properties; the detail about properties is wide ranging (check out the <a href="/sites/all/apidocs/classes/DataProperty.html"><em>DataProperty</em> </a>metadata object in the Breeze API docs). Perhaps most importantly, the <em>EntityType</em> knows how to create new instances of an entity type.</p>
